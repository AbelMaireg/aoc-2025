...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `105.3µs` | `108.2µs` |
| [Day 2](./src/bin/02.rs) | `32.0ms` | `119.8ms` |
| [Day 3](./src/bin/03.rs) | `46.4µs` | `124.1µs` |
| [Day 4](./src/bin/04.rs) | `303.3µs` | `4.9ms` |
| [Day 5](./src/bin/05.rs) | `97.1µs` | `20.6µs` |
| [Day 6](./src/bin/06.rs) | `103.5µs` | `94.8µs` |
| [Day 7](./src/bin/07.rs) | `126.5µs` | `126.3µs` |
